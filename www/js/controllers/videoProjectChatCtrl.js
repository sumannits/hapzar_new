app.controller('videoProjectChatCtrl', function ($scope,$rootScope, $stateParams,$location,$q,ionicMaterialInk,$ionicScrollDelegate,$timeout,$ionicPopup,myAuth,$ionicLoading,userService,$sce) {
