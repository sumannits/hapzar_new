app.controller('videoProjectChatOwnerCtrl', function ($scope,$rootScope, $stateParams,$location,$q,ionicMaterialInk,$ionicScrollDelegate,$timeout,$ionicPopup,myAuth,$ionicLoading,userService,$sce) {
