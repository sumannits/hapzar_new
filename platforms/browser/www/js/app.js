    ...
    $ionicPlatform.ready(function () {
        ...
        $rootScope.$on('$cordovaPushV5:notificationReceived', function(event, data){
          ...
          if(data.additionalData.type=='chat')
            {
                $state.go('user.details',{postId:data.additionalData.id})
            }
            else if(data.additionalData.type=='groupchat'){
              $state.go('user.groupchat',{postId:data.additionalData.id})
            }else{
              $state.go('user.alert');
            }
...
app.run(['$rootScope', '$state', '$stateParams',
  function ($rootScope, $state, $stateParams,myAuth) {
    ...
    //$rootScope.serviceurl = "http://getgo-app.com/getgo/getGoAPI/";
    $rootScope.serviceurl = "http://107.170.152.166/team2/project_management/projectMngmtAPI/";
...
.state('user.add_job', {
      ...
      cache: false,
        ...
        'homeview': {
            ...
            resolve: loadSequence('projectmanage','ngMap'),
...
.state('user.home_details', {
      ...
      views: {
        'homeview': {
            ...
            resolve: loadSequence('projectdetail'),
  ...
  .state('user.user_project_details', {
      ...
      views: {
        'homeview': {
            ...
            resolve: loadSequence('userprojectdetail'),
    ...
    .state('user.alert_info', {
      ...
      views: {
        'homeview': {
            ...
            resolve: loadSequence('alertaccept'),
